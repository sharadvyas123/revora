...
/** Explicit purchase confirmation has not been recorded */
class ConfirmationRequiredError extends ACGError {
  constructor(mandateId) {
    super(`Explicit user confirmation required before payment can be executed for mandate ${mandateId}`, {
      code: 'CONFIRMATION_REQUIRED',
      statusCode: 403,
      details: { mandate_id: mandateId },
      recovery: {
        action: 'REQUEST_CONFIRMATION',
        suggestion: 'Call POST /api/v1/mandates/cart/confirm with user_confirmation: true before executing payment',
      },
    });
  }
}
